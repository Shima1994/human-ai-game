...
The goal of this study was to investigate how humans and AI systems develop shared understanding while collaborating on a cooperative word association game.

During the game, either the human participant or the AI system acted as the clue-giver, while the other acted as the guesser. By observing how clues were interpreted, we aimed to better understand how shared meaning develops between humans and AI systems.

### Why is this important?

As AI systems become increasingly integrated into education, work, and everyday life, successful collaboration between humans and AI becomes more important. Even when both the human and the AI are working toward the same goal, they may interpret the same information differently.

Misunderstandings can occur, and successful collaboration often depends on the ability to repair these misunderstandings through feedback and clarification. This study investigates how such shared understanding develops and whether short reflection opportunities can support better communication between humans and AI systems over time.

### Were there different versions of the game?

Yes. Participants were assigned to one of two technical versions of the game:

1. **Static Baseline:** Reflection responses were collected for analysis but were not shared between teammates or used by the AI during later turns.
2. **Adaptive AI:** Reflection responses could be shown to the teammate and incorporated into later AI interactions, allowing communication to adapt over time.
...
The data will contribute to a Master’s thesis at the University of Duisburg-Essen and may also be used in future academic publications or research projects.

Results will only be reported in aggregated or anonymized form

### Do you have any questions?

If you have any questions about this study or would like to learn more about the results, you can contact:
